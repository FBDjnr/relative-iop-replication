...
# CSV
readr::write_csv(nss_aggregate_df, file.path(data_dir, paste0("nss64_aggregate_df_", ver,".csv")))

# Stata File
haven::write_dta(nss_aggregate_df, file.path(data_dir, paste0("nss64_aggregate_df_", ver,".dta")))
