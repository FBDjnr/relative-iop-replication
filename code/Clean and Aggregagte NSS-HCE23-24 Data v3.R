...
data_dir <- file.path("..", "Data Sets", "DDI-IND-MOSPI-NSS-HCES23-24", "NSS-HCES23-24")
...
# CSV
readr::write_csv(nss_aggregate_df, file.path(data_dir, paste0("nss_hce23_24_aggregate_df_", ver ,".csv")))

# Stata File
haven::write_dta(nss_aggregate_df, file.path(data_dir, paste0("nss_hce23_24_aggregate_df_", ver ,".dta")))
