...
% --- Tighten white space around and inside table/figure floats --------------
% Body text stays at \spacingset{1.8}; only the floats are compacted.
% \setlength{\textfloatsep}{8pt plus 2pt minus 2pt}   % gap between float and text
% \setlength{\floatsep}{8pt plus 2pt minus 2pt}       % gap between two floats
% \setlength{\intextsep}{8pt plus 2pt minus 2pt}      % gap around [h]/[H] floats
% \setlength{\abovecaptionskip}{4pt}
% \setlength{\belowcaptionskip}{2pt}
% \AtBeginEnvironment{table}{\setstretch{1}}          % single-space table bodies
...
\begin{table}[htbp]
    ...
    \input{tables/tab_circumstance_variables}
...
\begin{table}[htbp]
    ...
    \input{tables/tab_circumstance_variable_desc}
...
\begin{table}[h]
    ...
    \input{tables/tab_nss64_summary_stats_results}    
...
\begin{table}[h]
    ...
    \input{tables/tab_nss_hce23_24_summary_stats_results}    
...
\begin{table}
    ...
    \input{tables/tab_nss64_iop_naive_vs_wtd}    
    % \end{adjustbox}
...
\begin{table}
    ...
    % \begin{adjustbox}{max totalsize={1\linewidth}{1\textheight},center}
    \input{tables/tab_nss_hce23_24_iop_naive_vs_wtd}  
    % \end{adjustbox}
...
\begin{table}
    ...
    \input{tables/tab_nss64_iop_design_effect}      
...
\begin{table}
    ...
    \input{tables/tab_nss_hce23_24_iop_design_effect}    
...
\begin{table}
    ...
    {\small
    \input{tables/tab_hyp_test_results_time}}
    \begin{tablenotes}
        \footnotesize
        \item[a] Difference $=$ Rel IOP for 2007--2008 $-$ Rel IOP for 2023--2024
        \item[b] 
...
\begin{table}
    ...
    \input{tables/tab_hyp_test_results_sector}
    \begin{tablenotes}
        \footnotesize
        \item[a] Difference $=$ Rel IOP for Rural $-$ Rel IOP for Urban
        \item[b] 
        $p\text{-value} \leq 0.001$: `***';\;
        $0.001 < p\text{-value} \leq 0.01$: `**';\;
        $0.01 < p\text{-value} \leq 0.05$: `*';\
...
\begin{table}[h]
    ...
    \input{tables/tab_nss64_ablation_pc_iop}    
...
\begin{table}[h]
    ...
    \input{tables/tab_nss_hce23_24_ablation_pc_iop}    
...
\begin{table}[htbp]
    ...
    \input{tables/tab_boot_ablation_pc_iop}}
    \begin{tablenotes}
        \footnotesize
        \item[1] Difference $=$ percentage change in Rel IOP for 2023--2024 $-$ percentage change in Rel IOP for 2007--2008
        \item[2] 
        $p\text{-value} \leq 0.001$: `***';\;
        $0.001 < p\text{-value} \leq 0.01$: `**';\;
        $0.01 < p\text{-value} \leq 0.05$: `*';\
