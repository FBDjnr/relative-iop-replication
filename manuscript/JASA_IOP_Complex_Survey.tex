...
\begin{table}[htbp]
    ...
    \input{../output/tables/tab_circumstance_variables}
...
\begin{table}[htbp]
    ...
    \input{../output/tables/tab_circumstance_variable_desc}
...
\begin{table}[h]
    ...
    \input{../output/tables/tab_nss64_summary_stats_results}    
...
\begin{table}[h]
    ...
    \input{../output/tables/tab_nss_hce23_24_summary_stats_results}    
...
\begin{table}
    ...
    \input{../output/tables/tab_nss64_iop_naive_vs_wtd}    
    % \end{adjustbox}
...
\begin{table}
    ...
    % \begin{adjustbox}{max totalsize={1\linewidth}{1\textheight},center}
    \input{../output/tables/tab_nss_hce23_24_iop_naive_vs_wtd}  
    % \end{adjustbox}
...
\begin{table}
    ...
    \input{../output/tables/tab_nss64_iop_design_effect}      
...
\begin{table}
    ...
    \input{../output/tables/tab_nss_hce23_24_iop_design_effect}    
...
\begin{table}
    ...
    \input{../output/tables/tab_hyp_test_results_time}    
...
\begin{table}
    ...
    \input{../output/tables/tab_hyp_test_results_sector}    
...
\begin{table}[h]
    ...
    \input{../output/tables/tab_nss64_ablation_pc_iop}    
...
\begin{table}[h]
    ...
    \input{../output/tables/tab_nss_hce23_24_ablation_pc_iop}    
...
\begin{table}
    ...
    \input{../output/tables/tab_boot_ablation_pc_iop}
\end{table}
\end{landscape}
